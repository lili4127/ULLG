...
//-------------------------------------------------------------------------------------------------
// IHoloPlayEditor Module
//-------------------------------------------------------------------------------------------------

/**
 * @class	IHoloPlayEditor
 *
...
class IHoloPlayEditor : public IModuleInterface
{
public:

	/**
	 * @fn	static inline IHoloPlayEditor& IHoloPlayEditor::Get()
	 *
	...
	static inline IHoloPlayEditor& Get()
	{
		return FModuleManager::LoadModuleChecked< IHoloPlayEditor >("HoloPlayEditor");
	}

	/**
	 * @fn	static inline bool IHoloPlayEditor::IsAvailable()
	 *
	...
	{
		return FModuleManager::Get().IsModuleLoaded("HoloPlayEditor");
	}
};
