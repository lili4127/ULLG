...
class FHoloPlayCaptureResolutionCustomization : public IPropertyTypeCustomization
{
public:
...
private:
	...
	TSharedPtr<SSpinBox<int32>> ResXWidget;
	TSharedPtr<SSpinBox<int32>> ResYWidget;
};
